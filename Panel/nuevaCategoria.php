          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active">                      
                <a href="listadoProductos.php"><button type="button" class="btn btn-block btn-success">Ver listado producto</button></a>
              </li>
              <li class="">                      
                <a href="nuevoProducto.php"><button type="button" class="btn btn-block btn-warning">Nueva producto</button></a>
              </li>
            </ol>
          </div>
        </div>
